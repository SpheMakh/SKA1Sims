...
interest. %This is intrinsically due to the fact that the survey speed for SKA-SUR is coming from
...
is included on each page to facilitate the reading of the tables in this section.
 ...
 \input{psf_mean-dec30}
 \input{psf_sym-dec30}
 \input{noise50k-dec30}
\end{landscape}
\begin{landscape}
 \begin{table}[H]
  \begin{tabular}{|lccccccccc|}\hline
...
Sythesis-ANalysis Estimators – Deconvolution algorithm for radio interferometric imaging, in prep. (2014)
 ...
 \bibitem{resolve} H. Junklewitz, M.A. Bell, T. EnBlin, 2014 ,arXiv:1401.4711
