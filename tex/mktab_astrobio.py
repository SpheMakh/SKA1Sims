...
for kk,(noise2500,origkey) in PIXNOISE.items():
  ...
  relnoise = noise2500/noise50_ref2;
  ...
  flux10 = 10*(freq/13800.)**-0.7; 
  snr10 = (flux10/noise2500) if noise2500 else 0;
